<template>
  <div class="attendance">
    ...
    <div class="attendance-item" style="margin: 15px 0">
      ...
      <div class="month" id="statistics-month-echarts"></div>
    </div>
    <div class="attendance-item">
...
export default {
  ...
  mounted () {
    // 日
    this.dayEcharts = echarts.init(document.getElementById("statistics-day-echarts"));
    this.renderDayEcharts(this.dayEcharts)
    ...
    // 月
    this.monthEcharts = echarts.init(document.getElementById("statistics-month-echarts"));
    this.renderMonthEcharts(this.monthEcharts)
    ...
    this.yearEcharts = echarts.init(document.getElementById("statistics-year-echarts"));
    this.renderYearEcharts(this.yearEcharts)
