  ...
  <div class="checking">
    ...
    <div class="checking_wrapper">
      <ul class="checking_tab">
        <li @click="currentTab = 'kaoqin'" :class="{'checking_tab-selected': currentTab === 'kaoqin'}"><p class="home_title">人员考勤列表</p></li>
        <li v-show="subCompany==='北京桩机'" @click="currentTab = 'guiji'" :class="{'checking_tab-selected': currentTab === 'guiji'}" ><p class="home_title" >人员轨迹图表</p></li>
      </ul>
