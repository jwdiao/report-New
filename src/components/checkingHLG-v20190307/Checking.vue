				...
				<el-tab-pane label="人员考勤" name="kaoqin">
					<div class="checking_job" v-show="$store.state.centername===''">
						<div class="checking_item">
							...
							<ul class="checking_item-wrapper">
								<el-scrollbar style="height:100%;">
									<li v-for="item in kaoqinList.lateList" :key="item.id" :title="item.centerName">
						...
						<div class="checking_item">
							...
							<ul class="checking_item-wrapper">
								<el-scrollbar style="height:100%;">
									<li v-for="item in kaoqinList.leaveList" :key="item.id" :title="item.centerName">
										<span v-text="item.centerName"></span>
						...
						<div class="checking_item">
							...
							<ul class="checking_item-wrapper">
								<el-scrollbar style="height:100%;">
									<li v-for="item in kaoqinList.absentList" :key="item.id" :title="item.centerName">
										<span v-text="item.centerName"></span>
						...
						<div class="checking_item">
							...
							<ul class="checking_item-wrapper">
								<el-scrollbar style="height:100%;">
									<li v-for="item in kaoqinList.abnormalList" :key="item.id" :title="item.centerName">
										<span v-text="item.centerName"></span>
