    ...
    dayInfo (val) {
      ...
      if (this.dayInfo && this.dayInfo.ret == 200) {
        ...
        this.dayEchartsRightData = {
          ...
          abnormalNumArr:val.abnormalNumArr,//未派工
          absentNumArr:val.absentNumArr,// 未到
          lateNumArr:val.lateNumArr,//迟到
          outNumArr:val.outNumArr,// 离岗
    ...
    monthInfo (val) {
      if (this.monthInfo && this.monthInfo.ret === '200') {
        ...
        this.monthEchartsRightData = {
          ...
          zaotui : val.leaveNumArr, // 早退
          kuanggong : val.absenNumArr, //矿工
          abnormalnum:val.abnormalnum,//未派工20190529
