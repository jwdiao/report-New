        ...
        <div class="leftTopPersonNum">
          <div class="leftWarp">
            <p class="titleText1 titleText">计件总人数
              <em class="titleTotalNum">{{userCount || 0}}<em>人</em></em>
            </p>
            <p class="titleText1">劳务人数
              <em class="titleTotalNum">{{userCount || 0}}<em>人</em></em>
            </p>
            <p class="titleText1">冗余人数
              <em class="titleTotalNum">{{userCount || 0}}<em>人</em></em>
            </p>
          ...
          <div class="statusList">
            <ul class="statusListTop">
              ...
              <li>
                ...
                <div class="statusDiv2 statusDivFirst">
                  <em class=" statusCount num" v-show="info&&info.planTotalNum" v-text="info.planTotalNum" style="letter-spacing:0px;">0</em>
                  <em class="statusCount num" v-show="!info || !info.planTotalNum" style="letter-spacing:0px;">0</em>
                  <em class="statusDanw">人</em>
                  <div class="dayNightNumBox">
              ...
              <li>
                ...
                <div class="statusDiv2">
                  <em class="statusCount num" style="letter-spacing:0px;">{{info.planNum}}</em>
                  <em class="statusDanw">人</em>
                  <em style="display: inline-block;vertical-align: middle;font-size: 0.24rem;color: #32CD71;margin-left: 10px;">
                    ({{dayOrNightStatus.substring(0,1)}})
                  </em>
                </div>
              </li>
  ...
  methods: {
    ...
    renderEchartsCircle() {
      ...
      this.workPlanRateObjnew = {
        ...
        value: this.info.workPlanRate - 10
      }
      ...
      this.workPlanRateObjnew = {
        ...
        value: parseFloat(this.info.onworkRate) > 100 ? '100' : this.info.onworkRate - 30
      }
    ...
    .leftTopPersonNum{
      ...
      .statusList {
        ...
        .statusListTop {
          ...
          display: flex;
          align-items: center;
          background: url("../../assets/images/num_bg.png") no-repeat;
          background-size: 100% 100%;
          margin-bottom: 10px;
          padding-left: 20px;
          li {
