<template>
  <div class="index">
    ...
    <div class="index_top">
      ...
      <div class="title"><span @click="showSelectDialog">北京回龙观园区考勤数据中心</span></div>
      <div class="leftInfo">
...
import AbnormalStatistics from '@/components/checkingHLG-v20190307/AbnormalStatistics'
import Attendance from '@/components/checkingHLG-v20190307/Attendance'
import EnergyStatistics from '@/components/checkingHLG-v20190307/EnergyStatistics'
import Checking from '@/components/checkingHLG-v20190307/Checking'
import MachingCenter from '@/components/checkingHLG-v20190307/MachingCenter'
...
export default {
  ...
  methods: {
    ...
    // 中间==人员考勤列表==获取雷达图数据
    async getLeidaData () {
      const res = await getRecordRadarChart(this.$store.state.allCenterList.length)
      this.$store.commit('getRadarChartsMut', res)
    },
    // 点击加工中心重新请求数据
