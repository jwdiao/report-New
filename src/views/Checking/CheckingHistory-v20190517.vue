<template>
  <div class="index">
    ...
    <div class="index_top">
      ...
      <div class="leftInfo">
        <div class="back" @click="enterIndexPage('/CheckingHistoryData20190517')"><img style="width: 0.88rem;" src="../../assets/images/index_back.png"></div>
...
import CheckingLeftTopNumHistory from '@/components/checking-v20190517/CheckingLeftTopNumHistory'
import Attendance from '@/components/checking-v20190517/AttendanceHistory'
// import EnergyStatistics from '@/components/checking-v20190227/EnergyStatisticsHistory'
import Checking from '@/components/checking-v20190517/CheckingHistory20190517'
import MachingCenter from '@/components/checking-v20190517/MachingCenterHistory'
import HeaderToSelected from '@/components/checking-v20190517/HeaderToSelected'
import CheckingLeftCenterEchartsHistory from '../../components/checking-v20190517/CheckingLeftCenterEchartsHistory'
...
export default {
  ...
  methods: {
    ...
    enterChecking () {
      ...
      this.$router.replace('/CheckingV8')
    },
