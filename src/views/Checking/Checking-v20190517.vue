...
import Attendance from '@/components/checking-v20190517/Attendance'    // 日月年echarts
import EnergyStatistics from '@/components/checking-v20190517/EnergyStatistics'  // 能源指标列表echarts
import Checking from '@/components/checking-v20190517/Checking20190517.vue'
import MachingCenter from '@/components/checking-v20190517/MachingCenter'
import HeaderToSelected from '@/components/checking-v20190517/HeaderToSelected'    //头部下拉选项
import CheckingLeftTopNum from '../../components/checking-v20190517/CheckingLeftTopNum' //20190517 左上考勤人数
import CheckingLeftCenterEcharts from '../../components/checking-v20190517/CheckingLeftCenterEcharts' //20190517左中考勤echarts图表
