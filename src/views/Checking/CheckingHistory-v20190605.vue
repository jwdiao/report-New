<template>
  <div class="index">
    ...
    <div class="index_top">
      ...
      <div class="leftInfo">
        <div class="back" @click="enterIndexPage('/CheckingHistoryData20190605')"><img style="width: 0.88rem;" src="../../assets/images/index_back.png"></div>
...
import CheckingLeftTopNumHistory from '@/components/checking-v20190605/CheckingLeftTopNumHistory'
import Attendance from '@/components/checking-v20190605/AttendanceHistory'
import Checking from '@/components/checking-v20190605/CheckingHistory20190605'
import MachingCenter from '@/components/checking-v20190605/MachingCenterHistory'
import HeaderToSelected from '@/components/checking-v20190605/HeaderToSelected'
import CheckingLeftCenterEchartsHistory from '../../components/checking-v20190605/CheckingLeftCenterEchartsHistory'
...
export default {
  ...
  methods: {
    ...
    enterChecking () {
      ...
      this.$router.replace('/CheckingV9')
    },
...
.index{
  ...
  &_main{
    position: fixed;top:75px;left:15px;right:15px;bottom:15px;
