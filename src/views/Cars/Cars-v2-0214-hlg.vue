  ...
  <div class="index">
    ...
    <div class="index_top">
      <div class="index_imgText">
        <span class="title" @click="switchData('/CarsV21')">{{NTitleName}}车辆统计报表</span>
      </div>
      ...
      <div class="index_left">
        ...
        <div class="index_left_bottom">
          ...
          <div class="search">
            ...
            <el-select  class="module" v-model="value" @change="cheliangtypeFn" clearable @clear="clearType" placeholder="车辆类型">
              <el-option
...
<script>
  ...
  import {reqHLGCarsData,reqLeftCarsData}from'../../api'
  ...
  export default {
    ...
    methods: {
      ...
      async getCarAllData(carBelong,carType,page,pageSize){
        const res = await reqLeftCarsData(carBelong,carType,page+'',pageSize+'')
       ...
       if(res.data.code === 200){
         ...
         this.carArrNew = res.data.data.pageStrandedList
    ...
    * */
      ...
      * */
      cheliangtypeFn(val){
        ...
        if(obj.label==='大货车'){
          this.cheliangtype = '大型车'
        }else if(obj.label==='小车'){
          this.cheliangtype = '小型车'
        }
