...
export default {
  ...
  methods: {
    ...
    // 点击表格一条
    handleSeletedCurrentDevice (item) {
      console.log('选中的数据：',item) //cameraUuid==null
  ...
  &_con{
    ...
    &Bottom{
      ...
      .energyDevice_workStatus{
        height:100%;width: 290px;float: left;
        background-color: rgba(39, 69, 111, 0.3);
        padding: 15px;
        border: 1px solid rgba(255, 255, 255, 0.1);
        .title{
        ...
        .content{
          ...
          .text{ font-size: 18px; color:#fff; float: left;text-align: right;width: 126px;}
          .nums{ font-size: 22px; color: #02c9fc;margin-left:8px;}
        }
      }
      .energyDevice_dianLiu{
        height:100%;margin-left:315px;
        background-color: rgba(39, 69, 111, 0.3);
        padding: 15px;
        border: 1px solid rgba(255, 255, 255, 0.1);
        .top{
